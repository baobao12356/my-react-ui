...
export function Pagination(props: PropsWithChildren<PaginationProps>) {
  const {
    pageSize = Pagination.defaultProps.pageSize,
    defaultCurrent = Pagination.defaultProps.defaultCurrent,
    barMaxSize = Pagination.defaultProps.barMaxSize,
    total,
    callback
  } = props || Pagination.defaultProps;
